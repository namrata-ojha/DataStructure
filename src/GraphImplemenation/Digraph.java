...
/**
 * Created by namrataojha on 6/17/16.
 */
/*
...
public class Digraph<V> {
    ...
    public void add (V from, V to) {
        ...
        if(!this.isDag()){
            System.out.println("Cycle detected From"+ from +":"+"To"+ to);
            this.remove(from, to);
        }
    }
    ...
    /**
     * Report (as a ListNode) the topological sort of the vertices; null for no such sort.
     */
