package LinkedList.AddTwoNumbersRepresentedByLinkedlists;

/**
 * Created by namrataojha on 7/29/16.
...
class LinkedList {
    ...
    Node addTwoLists(Node first, Node second) {
        ...
        while (first != null || second != null) //while both lists exist
        {
            ...
            sum = carry + (first != null ? first.data : 0) // if first is not equal to null then take first.data else take 0
